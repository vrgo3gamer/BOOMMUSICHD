...
const devs = ['262250339745398784'];//by ,$ ReBeL ء , 🔕#4777 'CODES SERVER'
...
client.on("message", message => {
 if (message.content === `${prefix}help`) {
  const embed = new Discord.RichEmbed() //by ,$ ReBeL ء , 🔕#4777 'CODES SERVER'
      ...
      .setDescription(`
${prefix}play ⇏ لتشغيل أغنية برآبط أو بأسم :arrow_forward: 

${prefix}skip ⇏ لتجآوز الأغنية الحآلية :fast_forward: 

${prefix}pause ⇏ إيقآف الأغنية مؤقتا:pause_button: 

${prefix}resume ⇏ لموآصلة الإغنية بعد إيقآفهآ مؤقتا :arrow_forward: 

${prefix}vol ⇏ لتغيير درجة الصوت 100 - 0 :speaker: :sound: :loud_sound: 

${prefix}stop ⇏ لإخرآج البوت من الروم :stop_button: 

${prefix}np ⇏ لمعرفة الأغنية المشغلة حآليا :musical_note:  

${prefix}queue ⇏ لمعرفة قآئمة التشغيل :notes:
 ...
 `)//by ,$ ReBeL ء , 🔕#4777 'CODES SERVER'
   message.channel.sendEmbed(embed)//by ,$ ReBeL ء , 🔕#4777 'CODES SERVER'
	...
	client.login("NDQ3NjA1NTQ5NTMwNDgwNjQw.Dfvy4g.Wpp31oeODmja6nNH9llq2hqkyKg");
